...
try:
    ...
    while True:
        if sensor.get_sensor_data() and sensor.data.heat_stable:
            ...
            print(f"Moisture Sensor 1: {moisture_level_1:.2f} -> Saturation: {saturation_level_1:.2f}")
            print(f"Moisture Sensor 2: {moisture_level_2:.2f} -> Saturation: {saturation_level_2:.2f}")
            print(f"Moisture Sensor 3: {moisture_level_3:.2f} -> Saturation: {saturation_level_3:.2f}")
            print("-" * 40)
